...
CREATE TABLE `BRANCH_BATCH_SUBJECTS` (
  `ID` int NOT NULL AUTO_INCREMENT,
  `BRANCH_BATCHES_ID` int DEFAULT NULL,
  `CUSTOMER_SUBJECT_HIRARCHY_ID` int DEFAULT NULL,
...
CREATE TABLE `STUDENT_FEE_STRUCTURE` (
  ...
  `DISCOUNT_ALLOWED` decimal(10,2) DEFAULT NULL,
  `PENDING_AMOUNT` decimal(10,0) DEFAULT NULL,
  `INSTALLMENT_AMT` decimal(10,2) DEFAULT NULL,
  `INSTALLMENT_TYPE` int DEFAULT NULL,
  `NO_OF_INSTALLMENT` int DEFAULT NULL,
  `CREATED_DATE` datetime DEFAULT NULL,
  `CREATED_BY` int DEFAULT NULL,
...
/* Procedure structure for procedure `SP_CREATE_BATCH` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP_CREATE_BATCH` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `SP_CREATE_BATCH`(IN P_BATCH_OBJECT JSON,
OUT P_OUT_FLAG VARCHAR(50)  
    )
BEGIN

#JSON VARIABLES
        DECLARE    J_V_BRANCHID INT;
    DECLARE    J_V_STUDENT_ID VARCHAR(4000);    
    DECLARE    J_V_NAME VARCHAR(150);
    DECLARE    J_V_ACADEMIC_YEAR_ID INT;
    DECLARE    J_V_START_DATE DATETIME;
    DECLARE    J_V_END_DATE DATETIME;
    DECLARE    J_V_CREATED_DATE DATETIME;
    DECLARE    J_V_CREATED_BY INT;
    DECLARE    J_V_START_TIME INT;
    DECLARE    J_V_END_TIME INT;
  ...
  DECLARE  V_ACTIVE INT;
		...
		SELECT              BRANCHID ,
		  ...
		  J_V_BRANCHID ,
            ...
            J_V_CREATED_BY 
			FROM
		 JSON_TABLE(P_BATCH_OBJECT, 
			  '$' COLUMNS (

            BRANCHID INT PATH '$.BranchId' ,
            STUDENT_ID VARCHAR(4000) PATH '$.StudentId' ,
            Name VARCHAR(250) PATH '$.Name' ,
            ACADEMIC_YEAR_ID INT PATH  '$.AcademicYearId' ,
            START_DATE DATETIME PATH '$.StartDate' ,
            END_DATE DATETIME PATH '$.EndDate' ,
            START_TIME INT PATH '$.StartTime' ,
            END_TIME INT PATH '$.EndTime' ,
            CREATED_DATE DATETIME PATH '$.CreatedDate',
            CREATED_BY INT PATH '$.CreatedBy'
...
/* Procedure structure for procedure `SP_INSERT_BRANCH_BATCHES` */

/*!50003 DROP PROCEDURE IF EXISTS  `SP_INSERT_BRANCH_BATCHES` */;

DELIMITER $$

/*!50003 CREATE PROCEDURE `SP_INSERT_BRANCH_BATCHES`(
  
IN P_NAME int (11),
IN P_BRANCH_ID  INT(11),
IN P_ACADEMIC_YEAR_ID int (11),
IN P_START_DATE DATETIME,
IN P_END_DATE DATETIME,
IN P_START_TIME int (11),
IN P_END_TIME int (11),
IN P_ACTIVE INT (11),
IN P_CREATED_BY int (11),
IN P_CREATED_DATE datetIME,
 OUT P_OUT_BRANCH_BATCHES_ID INT (11)
)
BEGIN
#START TRANSACTION;
...
SET P_OUT_BRANCH_BATCHES_ID= last_insert_id() ;
	END */$$
DELIMITER ;
