...
CREATE TABLE `COURSE_FEE_STRUCTURE` (
  `ID` int(11) NOT NULL,
  `BRANCH_COURSE_ID` int(11) DEFAULT NULL,
...
CREATE TABLE `STUDENT_COURSES` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `STUDENT_ID` int(11) DEFAULT NULL,
  `STUDENT_ADMISSION_DTL_ID` int(11) DEFAULT NULL,
...
CREATE TABLE `USER_MASTER` (
  ...
  `PRIMARY_CONTACTNO` int(11) NOT NULL,
  ...
  `MODIFIED_BY` int(11) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `USER_MASTER_UK2` (`CUSTOMER_ID`,`PRIMARY_CONTACTNO`),
...
SET V_STUDENT_DETAIL_ID=0;
    #First Student is exits or not if not exists then create user first
       ...
       IF TRIM(J_V_STUDENT_LOGIN) IS NULL OR J_V_STUDENT_LOGIN='' THEN
