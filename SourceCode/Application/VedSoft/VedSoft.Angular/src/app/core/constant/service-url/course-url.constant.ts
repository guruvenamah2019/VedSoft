...
export const STUDENT_SERVICE_URL = {
    ACTION_ADD_STUDENT: CONTROLLER_NAME.MASTER_CONTROLLER + '/AddStudent',
    ACTION_UPDATE_STUDENT: CONTROLLER_NAME.MASTER_CONTROLLER + '/UpdateStudent',
    ACTION_GET_STUDENT: CONTROLLER_NAME.MASTER_CONTROLLER + '/GetStudents',
    ACTION_MAKE_INACTIVE_STUDENT: CONTROLLER_NAME.MASTER_CONTROLLER + '/MakeInActiveStudent',
}
